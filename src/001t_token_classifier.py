# -*- coding: utf-8 -*-
"""nb001t-token-classifier.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/16oFOxFjBxrjrhm4ZecFIb-kfdGjDpKoL
...
if "google.colab" in sys.modules:
    ...
    base = "/content/drive/MyDrive/colab_notebooks/kaggle/nbme-score-clinical-patient-notes/src"
    os.chdir(base)
...
class CFG:
    wandb=True
    wandbgroup="001t-token-classifier"
...
CFG.wandbname = f"case-num-{sys.argv[1]}"
if CFG.wandbname == "case-num-all":
    CFG.cv_case_num = True
